package com.sunlands.hr.hanlp.test;
...
//		        {
//	                "香蕉", "苹果", "白菜", "水果", "蔬菜", "自行车", "公交车", "飞机", "买", "卖", "购入", "新年",
//	                "春节", "丢失", "补办", "办理", "送给", "寻找", "孩子", "教室", "教师", "会计",
//		        };
...
//		}
//		
//		System.out.println("香蕉" + "\t" + "苹果" + "\t之间的距离是\t" + CoreSynonymDictionary.distance("香蕉", "苹果"));
